...
public class ImageTextGroup1 extends LinearLayout {

    private static final String TAG = "ImageTextGroup";
    private CircleImage1 image;
    ...
    public ImageTextGroup1(Context context) {
        super(context);
        init(context);
    }

    public ImageTextGroup1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageTextGroup1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void getAttributes(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ImageTextGroup1, defStyleAttr, 0);
        image_bw = array.getDimensionPixelSize(R.styleable.ImageTextGroup1_group_bw1, DEFAULT_WIDTH);
        image_bw = image_bw < 0 ? 0 : image_bw;
        image_bc = array.getColor(R.styleable.ImageTextGroup1_group_bc1, DEFAULT_COLOR);
        image_size = array.getInteger(R.styleable.ImageTextGroup1_group_img_size1, 0);
        if (image_size > 0) image_size = dip2px(context, image_size);
        image_margin = array.getDimensionPixelSize(R.styleable.ImageTextGroup1_group_img_margin1, 0);
        image_margin = image_margin < 0 ? 0 : image_margin;
        image_marStart = array.getDimensionPixelSize(R.styleable.ImageTextGroup1_group_img_marStart1, 0);
        image_marStart = image_marStart < 0 ? 0 : image_marStart;
        image_marEnd = array.getDimensionPixelSize(R.styleable.ImageTextGroup1_group_img_marEnd1, 0);
        image_marEnd = image_marEnd < 0 ? 0 : image_marEnd;
        int image_marTop = array.getDimensionPixelSize(R.styleable.ImageTextGroup1_group_img_marTop1, 0);
        image_marTop = image_marTop < 0 ? 0 : image_marTop;
        int image_marBottom = array.getDimensionPixelSize(R.styleable.ImageTextGroup1_group_img_marBottom1, 0);
        ...
        src = array.getDrawable(R.styleable.ImageTextGroup1_group_src1);
        back = array.getDrawable(R.styleable.ImageTextGroup1_group_bg1);
        front = array.getDrawable(R.styleable.ImageTextGroup1_group_fg1);
        text_ts = array.getDimensionPixelSize(R.styleable.ImageTextGroup1_group_ts1, DEFAULT_WIDTH);
        text_tc = array.getColor(R.styleable.ImageTextGroup1_group_tc1, DEFAULT_COLOR);
        text_t = array.getString(R.styleable.ImageTextGroup1_group_text1);
        text_t = text_t == null ? "" : text_t;
        clickable = array.getBoolean(R.styleable.ImageTextGroup1_group_clickable1, false);
        String gravity = array.getString(R.styleable.ImageTextGroup1_group_tg1);
        ...
        int img_gv = array.getInteger(R.styleable.ImageTextGroup1_group_img_gv1, -1);
        ...
        text_ellipsize = array.getInteger(R.styleable.ImageTextGroup1_group_ellipsize1, 0);
        ell = getTruncateAt(text_ellipsize);
        text_maxLines = array.getInteger(R.styleable.ImageTextGroup1_group_maxLines1, 2);
...
//        if (height == WRAP_CONTENT || (height == MATCH_PARENT/* && params.height == WRAP_CONTENT*/)) {
////            if (params.height == WRAP_CONTENT || params.height == MATCH_PARENT) {
//                params.height = size + text_ts + DEFAULT_SIZE_DIFF;
//                Log.e(TAG, "heightSize:" + heightSize + "----params.height:" + params.height);
//                setLayoutParams(params);
//                heightMeasureSpec = MeasureSpec.makeMeasureSpec(params.height, heightMode);
////            }
//        }
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.image_text_layout1, this);
